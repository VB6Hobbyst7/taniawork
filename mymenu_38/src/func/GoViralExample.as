package func  
{
	...
	public class GoViralExample extends Sprite
	{
		...
		public static const FACEBOOK_APP_ID:String="277005535795275";	
		
		/** An embedded image for testing image attachments. */
		[Embed(source="../assets/320/icons/icon-512.png")]
		...
		public function init():void
		{
			...
			if (!checkLoggedInFacebook()){
				...
				log("Allready logged into facebook");
			}
		...
		{
			log("doing showmainui");
			if (buttonContainer)
			{
				removeChild(buttonContainer);
				buttonContainer=null;
			}
			log("did button container");
