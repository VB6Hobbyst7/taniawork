...
public class DataManager
{
	...
	private function generateData():void
	{
		...
		while (children.length>0)
		{
			...
			{
				_startAirportsValues[mapEntity.uid] = [MapAirport(mapEntity).internationalFlights,MapAirport(mapEntity).nationalFlights,MapAirport(mapEntity).otherFlights];
	...
	public function reset():void
	{
		...
		for each (mapAirport in _airports)
		{
			...
			mapAirport.otherFlights = _startAirportsValues[mapAirport.uid][2];
		}
