...
include("dbconnect.php");
   ...
   $Return .= "</date>";
    ...
    $Return .= "</val>";
   				...
   				$Return .= "<cat>";
   			$Query = "SELECT count(*) from list WHERE PY > ".$date3." and SC like '".$cat1."'";
  			$Result = mysql_query( $Query );
  			$Return .=mysql_result($Result, 0);
   			$Return .= "</cat>";
   			$Return .= "<cat>";
   			$Query = "SELECT count(*) from list WHERE PY > ".$date3." and SC like '".$cat2."'";
   			$Result = mysql_query( $Query );
  			$Return .=mysql_result($Result, 0);
   			$Return .= "</cat>";
   			$Return .= "<cat>";
   			$Query = "SELECT count(*) from list WHERE PY > ".$date3." and SC like '".$cat3."'";
   			$Result = mysql_query( $Query );
  			$Return .=mysql_result($Result, 0);
   			$Return .= "</cat>";
