...
public class EditButton extends ButtonSkin
{
	...
	[Embed(source="/assets/320/dpi320/redbox.png")]
	private var upImage:Class;
	
	[Embed(source="/assets/320/dpi320/redbox_down.png")]
	private var downImage:Class;
	
	[Embed(source="/assets/320/dpi240/redbox.png")]
	private var upImage240:Class;
	
	[Embed(source="/assets/320/dpi240/redbox_down.png")]
	private var downImage240:Class;

	[Embed(source="/assets/320/dpi160/redbox.png")]
	private var upImage160:Class;
	
	[Embed(source="/assets/320/dpi160/redbox_down.png")]
